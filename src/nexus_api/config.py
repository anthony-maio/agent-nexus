...
class ApiSettings(BaseSettings):
    ...
    APP_EXTERNAL_TOOL_CONFIG: str = Field(default="")
    ...
    APP_SYNTHESIS_HOST_ROOT: str = Field(default="")
    APP_SYNTHESIS_PROVIDER_TYPE: str = Field(default="mock")
    APP_SYNTHESIS_API_KEY: str = Field(default="")
    APP_SYNTHESIS_MODEL: str = Field(default="")
    APP_SYNTHESIS_BASE_URL: str = Field(default="")
