...
_MAIN_SWARM: list[ModelIdentity] = [
    ModelIdentity(
        ...
        role="Engineer",
        color=0x4A90D9,
        personality=("Methodical engineer who optimizes for correctness and practical impact"),
    ),
    ModelIdentity(
        model_id="z-ai/glm-5",
        name="Sage",
        ...
        role="Architect",
        color=0x9B59B6,
        personality=("Strategic architect who plans before acting and self-corrects"),
    ),
    ModelIdentity(
        ...
        role="Explorer",
        color=0xE67E22,
        personality=("Curious explorer who excels at tool use and multimodal reasoning"),
    ),
    ModelIdentity(
...
_PREMIUM_SWARM: list[ModelIdentity] = [
    ...
    ModelIdentity(
        ...
        role="Catalyst",
        color=0xF1C40F,
        personality=("Fast-moving catalyst who generates ideas and prototypes rapidly"),
    ),
    ModelIdentity(
...
IDENTITIES: dict[str, ModelIdentity] = {
    identity.model_id: identity for identity in (*_MAIN_SWARM, *_PREMIUM_SWARM, *_TASK_AGENTS)
}
